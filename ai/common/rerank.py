'''
Reranks grouped search results by examining the entire group. The group
is then assigned a ranking score
'''
import re
from typing import List
from rank_bm25 import BM25Okapi  # type: ignore
from ..common.schema import Doc, DocGroup
...
class ReRank:
    ...
    def rerankDocuments(
        ...
        '''
        This uses the BM25 reranker to rerank the result documents. It does
        this by passing the page content over to the reranker
        '''
    ...
    def rerankGroups(
        ...
        '''
        This uses the BM25 reranker to rerank the result document groups. It does
        this by combining all the document chunks within a group together and
        ...
        for group in groups:
            # Sort them by chunk
            group.documents.sort(key=lambda doc: doc.metadata['chunk'])
